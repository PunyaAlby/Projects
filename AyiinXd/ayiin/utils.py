...
async def autobot():
    ...
    await bot.send_message(
        BOTLOG_CHATID, "**TUNGGU SEBENTAR SAYANGG.. SEDANG MEMBUAT ASSISTANT BOT ANDA DI @BotFather**"
    )
    LOGS.info("TUNGGU SEBENTAR SAYANG. SEDANG MEMBUAT ASSISTANT BOT UNTUK ANDA")
